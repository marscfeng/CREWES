...
%       rotation, amplitude scalar, and dominant frequency. 1 means produce
...
if(strcmp(action,'init'))
    ...
    set(hax1,'xticklabel',[])
    title(['seis1: ' title1],'interpreter','none');
    ...
    title(['seis2: ' title2],'interpreter','none')
    xlabel('distance (m)')
