...
%     brighten(.5);
    ...
    ynow2=ynow2-ht;
    nudge=.1*ht;
    uicontrol(gcf,'style','text','string','Sigmax(G):','units','normalized','position',[xnow,ynow2-nudge,wid,ht],...
        'tooltipstring','Gross filtering: the smaller the number the greater the filtering','backgroundcolor','w');
    uicontrol(gcf,'style','popupmenu','string',sigmaxvals,'units','normalized','position',[xnow+wid,ynow2,wid,ht],...
    ...
    ynow2=ynow2-.5*ht;
    uicontrol(gcf,'style','text','string','Sigmay(G):','units','normalized','position',[xnow,ynow2-nudge,wid,ht],...
        'tooltipstring','Gross filtering: the smaller the number the greater the filtering','backgroundcolor','w');
    hsigmay=uicontrol(gcf,'style','popupmenu','string',sigmayvals,'units','normalized','position',[xnow+wid,ynow2,wid,ht],...
    ...
    ynow2=ynow2-.5*ht;
    nudge=.1*ht;
    uicontrol(gcf,'style','text','string','Sigmax(D):','units','normalized','position',[xnow,ynow2-nudge,wid,ht],...
    ...
    uicontrol(gcf,'style','popupmenu','string',sigmaxvals,'units','normalized','position',[xnow+wid,ynow2,wid,ht],...
        ...
        'callback','seisplotsvd_foot(''sigmachange'');');
    ynow2=ynow2-.5*ht;
    uicontrol(gcf,'style','text','string','Sigmay(D):','units','normalized','position',[xnow,ynow2-nudge,wid,ht],...
        'tooltipstring','Detail filtering: the smaller the number the greater the filtering','backgroundcolor','w');
    uicontrol(gcf,'style','popupmenu','string',sigmayvals,'units','normalized','position',[xnow+wid,ynow2,wid,ht],...
    ...
    uicontrol(gcf,'style','pushbutton','string','Info','tag','info','units','normalized',...
        'userdata',msg,'position',[xnow,ynow+1.5*ht,.5*wid,.5*ht],'callback','seisplotsvd_foot(''info'');',...
